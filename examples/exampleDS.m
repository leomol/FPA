...
configuration.dffLowpassFrequency = configuration.peaksBandpassFrequency(2);
...
switch option
    case 1
        ...
        configuration.f0Window = 120;
        configuration.f1Function = @movstd;
        configuration.f1Window = 120;
    case 2
    ...
    case 3
        ...
        configuration.f0Window = 120;
        configuration.f1Function = @movmedian;
        configuration.f1Window = 120;
end
