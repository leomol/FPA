% LabChart.Mat.load - Loads a dot-mat file exported from LabChart.
% 
% [time, data, units, comments, names] = LabChart.Mat.load(filename)
% 
...
function [time, data, units, comments, names] = load(filename)
    vars = load(filename);
