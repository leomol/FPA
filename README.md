...
Returns a `data` matrix where columns correspond to the `datasets` provided. When `datasets` is not provided, the function attempts to retrieve data assuming one of two typical layouts:
```
